...
//tally the smarturls to campaign or vendor at the end of script.
...
"https://www.golookonline.com/r/4bb5012d31/?",
//"https://www.golookonline.com/r/4bb503643b/?",
//"https://www.golookonline.com/r/4bd865daef/?",
//"https://www.golookonline.com/r/4ddab82724/?"
        );
...
setcookie('server_magic', 'mrwhite', time() + 3600, '/', 'www.golookonline');
    ...
    //campaigns with pixels
    //foreach ($pixleLinks as $link) {
     //all links random
    foreach ($b as $link) { 
$webdriver = new WebDriver("localhost", "4444");
$webdriver->connect("firefox");
