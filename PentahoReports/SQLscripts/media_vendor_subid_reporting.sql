...
round(act1.current_rate,2) as "CPL",
act1.vertical_id,
...
sum(ifnull(act2.client_conversions,0) * ifnull(act2.current_rate,0)) as "Total Sales Revenue"
from
aggregate_campaign_subid_transactions as act1
...
left join aggregate_campaign_subid_transactions as act2 
/** as a rule of thumb is always better to join on at least 2 parameters when joining the same table **/
on 
act1.subid = act2.subid 
AND act1.campaign_id = act2.campaign_id 
...
and act1.campaign_id = ${input_campaign_id}
